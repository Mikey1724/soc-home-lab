...
Practice network traffic analysis by examining real-world PCAP files from malware-traffic-analysis.net. The goal is to identify compromised hosts, malicious activity, and document Indicators of Compromise (IOCs) using a structured SOC analyst methodology.
